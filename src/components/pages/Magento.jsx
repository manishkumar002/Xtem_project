    ...
    <div className='Container-fluid'>
       ...
       <div className='col-sm-1'></div>
        <div className='col-sm-10 business1'>
            <center>
                <h5 className='mt-3' style={{fontFamily:"Segoe UI Black"}}>MAGENTO DEVELOPER
</h5>
                <hr/>
            </center>
            <div className='row'>
            ...
            <div className='row'>
                ...
                <hr/>
                <ul>
    <li>Knowledge of Front End / Back End of MAGENTO 2.x.</li>
<li>Ability to develop custom modules & customize existing 
